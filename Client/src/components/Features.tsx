...
export default function Features() {
  return (
    <section className="w-full py-20 md:py-32 bg-slate-50/50 dark:bg-slate-900/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-3 gap-4 max-w-6xl mx-auto auto-rows-fr">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className={`${feature.className} group relative overflow-hidden border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-300 hover:shadow-lg`}
              >
                <div
                ...
                <div className="relative p-6 md:p-8 h-full flex flex-col justify-between">
                  <div>
                    <div className="mb-4">
                      <div className="inline-flex p-3 rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-slate-200 dark:border-slate-800">
