...
export default function Footer() {
  return (
    <footer className="w-full border-t border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-900/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300">
              Transform lengthy articles into clear, concise summaries with the
              power of AI.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
              ...
              <li>
                <a
                  href="https://github.com/Leonardo1903/Concise"
                  target="_blank"
