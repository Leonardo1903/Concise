...
//           <button
//             type="submit"
//             className="absolute right-0 my-2 mr-3 rounded-md bg-black py-2.5 px-4 text-sm font-medium text-white transition-all peer-focus:border-gray-700 peer-focus"
//           >
...
import { useState, useEffect } from "react"
import { Copy, Link2, Loader2, Check, ExternalLink, Trash2 } from "lucide-react"
import { useLazyGetSummaryQuery } from "@/services/article"
    ...
    <section className="w-full max-w-xl mx-auto">
      <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm dark:bg-slate-900/80">
        <CardHeader className="pb-2">
          ...
          <CardDescription>Enter a URL to an article you want to summarize</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {allArticles.length > 0 && (
            <div className="mt-4">
              <h3 className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">History</h3>
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>{copiedUrl === item.url ? "Copied!" : "Copy URL"}</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
          ...
          {isFetching ? (
            ...
            <Card className="border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              <CardContent>
                <div className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">{article.summary}</div>
              </CardContent>
            </Card>
          ) : null}
        </CardContent>
